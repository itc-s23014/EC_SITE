...
const TestPage = () => {
  ...
  <div class="flex bg-gray-50 border focus-within:bg-transparent focus-within:border-gray-400 rounded-full px-4 py-2.5 overflow-hidden max-w-76 max-lg:hidden">

    <label for="category-filter" class="sr-only">Category Filter</label>
    <select id="category-filter" class="bg-transparent text-sm outline-none pr-2  min-w-20 max-w-sm text-ellipsis overflow-hidden">
    <option value="category" disabled selected>カテゴリ</option>
    <option value="all">All</option>
      <option value="new">New</option>
      <option value="men">Men</option>
      <option value="women">Women</option>
      <option value="kids">Kids</option>
      <option value="accessories">Accessoriesaaaaaaaaaaaaaaaaaaa</option>
    </select>
